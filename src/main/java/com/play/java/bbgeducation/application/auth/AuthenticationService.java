...
public interface AuthenticationService {
    OneOf2<AuthenticationResult, ValidationFailed> authenticate(EmailAddress email, String password);
    OneOf2<Success, ValidationFailed> register(EmailAddress email, String password, FirstName firstName, LastName lastName, boolean isAdmin);
